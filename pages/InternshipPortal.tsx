...
const MOCK_OPPORTUNITIES: ExtendedInternship[] = [
  { 
    id: '1', 
    company: 'Google', 
    ...
    difficulty: 'Hard', 
    eligibleYear: [2025, 2026], 
    postedDate: '2 days ago',
    deadline: 'Nov 15',
    isVerified: true, 
    verificationSource: 'Placement Cell',
...
const InternshipPortal: React.FC = () => {
  ...
  const filteredOpportunities = useMemo(() => {
    return MOCK_OPPORTUNITIES.filter(item => {
  ...
  }, [search, filterType, user, savedIds, appliedIds]);
